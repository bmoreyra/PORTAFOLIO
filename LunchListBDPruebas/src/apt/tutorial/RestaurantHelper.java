...
class RestaurantHelper extends SQLiteOpenHelper {
  //private static final String DATABASE_NAME="lunchlist.db";quiero ver si importa el nombre de la bd
  private static final String DATABASE_NAME="lunchlistBD2.db";
  ...
  public Cursor getAll(String orderBy) {
    return(getReadableDatabase()
            .rawQuery("SELECT _id, name, address,phone, type, notes FROM restaurants ORDER BY "+orderBy,
                      null));
  }
  ...
  public Cursor getById(String id) {
    ...
    return(getReadableDatabase()
            .rawQuery("SELECT _id, name, address, phone,type, notes FROM restaurants WHERE _ID=?",
                      args));
  }
